...
class TestDatabase(unittest.TestCase):
    ...
    def test_execute_update_insert(self):
        ...
        result = self.db.execute_query("SELECT * FROM players WHERE id = 'test_player_id'")
        self.assertEqual(len(result), 1)
        self.assertEqual(result[0]['name'], 'Test Player')

    def test_execute_query(self):
        """Test querying data with execute_query."""
        self.db.execute_update("INSERT INTO players (id, name) VALUES ('query_player', 'Query Player')")
    ...
    def test_execute_update_update(self):
        ...
        self.db.execute_update("INSERT INTO players (id, name) VALUES ('update_player', 'Initial Name')")
        ...
        result = self.db.execute_query("SELECT * FROM players WHERE id = 'update_player'")
        self.assertEqual(result[0]['name'], 'Updated Name')

    def test_execute_update_delete(self):
        """Test deleting data with execute_update."""
        self.db.execute_update("INSERT INTO players (id, name) VALUES ('delete_player', 'Delete Me')")
        ...
        result = self.db.execute_query("SELECT * FROM players WHERE id = 'delete_player'")
